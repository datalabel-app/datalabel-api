...
<body>
    <div class=""container"">
        ...
        public static string GetForgotPasswordEmail(string fullName, string email, string newPassword)
        {
            return $@"
<!DOCTYPE html>
<html>
        ...
        <div class=""content"">
            ...
            <div class=""credentials"">
                ...
                <div class=""credentials-item"">
                    ...
                    <span class=""credentials-value password-value"">{newPassword}</span>
                </div>
            </div>
            ...
            <div class=""warning"">
                ...
                <ul style=""margin: 10px 0; padding-left: 20px;"">
                    ...
                    <li><strong>Bạn bắt buộc phải đổi mật khẩu</strong> sau khi đăng nhập</li>
                    <li>Không chia sẻ mật khẩu này với bất kỳ ai</li>
                    <li>Nếu bạn không yêu cầu, hãy liên hệ admin ngay</li>
                </ul>
            </div>
            
            <p>Vui lòng đăng nhập vào hệ thống và tiến hành đổi mật khẩu để đảm bảo an toàn.</p>
